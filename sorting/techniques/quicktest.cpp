...
void qsplit(const std::string &s, std::string sep, std::vector<std::string> &read)
{
...
void  quicktest()
{
	std::cout << "hello starting of quicksortprogram for testing random text file\n";
	...
	std::cout << "hello starting of quicksortprogram for testing ascending text file\n";
	...
	std::cout << "hello starting of quicksortprogram for testing descending text file\n";
