...
void insplit(const std::string &s, std::string sep, std::vector<std::string> &read)
{
...
void  insertiontest()
{
	std::cout << "hello starting of insertionprogram for testing random text file\n";
	...
	std::cout << "hello starting of insertionsortprogram for testing ascending text file\n";
	...
	std::cout << "hello starting of insertionsortprogram for testing decending text file\n";
