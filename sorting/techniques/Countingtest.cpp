...
void ccsplit(const std::string &s, std::string sep, std::vector<std::string> &read)
{
...
void  countingtest()
{
	std::cout << "hello starting of countingprogram for testing random text file\n";
	...
	std::cout << "hello starting of countingprogram for testing ascending text file\n";
	...
	std::cout << "hello starting of countingprogram for testing descending text file\n";
