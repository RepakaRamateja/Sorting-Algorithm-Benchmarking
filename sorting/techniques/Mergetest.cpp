...
void msplit(const std::string &s, std::string sep, std::vector<std::string> &read)
{
...
void  mergetest()
{
	std::cout << "hello starting of mergeprogram for testing random text file\n";
	...
	std::cout << "hello starting of mergeprogram for testing ascending text file\n";
	...
	std::cout << "hello starting of mergeprogram for testing descending text file\n";
