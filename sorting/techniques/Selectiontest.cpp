...
void sesplit(const std::string &s, std::string sep, std::vector<std::string> &read)
{
...
void  selectiontest()
{
	std::cout << "hello starting of selectionsortprogram for testing random text file\n";
	...
	std::cout << "hello starting of selectionsortprogram for testing ascending text file\n";
	...
	std::cout << "hello starting of selectionsortprogram for testing descending text file\n";
