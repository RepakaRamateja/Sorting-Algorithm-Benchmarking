...
void csplit(const std::string &s, std::string sep, std::vector<std::string> &read)
{
...
void  Combtest()
{
	std::cout << "hello starting of combprogram for testing random text file\n";
	...
	std::cout << "hello starting of combprogram for testing assending text file\n";
	...
	std::cout << "hello starting of combprogram for testing decending text file\n";
