...
#include"BubbleSort.h"
	...
	void  bubbletest()
	{
		...
		std::cout << "hello starting of bubbleprogram for testing random text file\n";
		...
		std::cout << "hello starting of bubbleprogram for testing ascending text file\n";
		...
		std::cout << "hello starting of bubbleprogram for testing desending text file\n";
