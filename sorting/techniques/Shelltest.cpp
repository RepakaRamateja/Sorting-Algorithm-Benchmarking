...
void slsplit(const std::string &s, std::string sep, std::vector<std::string> &read)
{
...
void  shelltest()
{
	std::cout << "hello starting of shellsortprogram for testing random text file\n";
	...
	std::cout << "hello starting of shellsortprogram for testing ascending text file\n";
	...
	std::cout << "hello starting of shellsortprogram for testing descending text file\n";
